...
class MCAPI {
    ...
    /**
     * Sets timeout
     * @param int $seconds The number of seconds for the timeout
     * @return MCAPI
     */
     ...
     * @return boolean True if there was an error, false if there is not
     */
     ...
     * @return array Array with keys errorCode and errorMessage. Both will be empty if there was no error
     */
